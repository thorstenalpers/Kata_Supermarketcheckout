namespace SupermarketCheckout.WebAPI
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            ConfigureBusinessServices(services, _config);
        ...
        public static void ConfigureBusinessServices(IServiceCollection services, IConfiguration config)
        {
            // add db context
            ...
            services.AddTransient<ISupermarketStoreService, SupermarketStoreService>();
